 ...
 * stages. In half-open state, configure multiple ratio stages to determine
 * how much percentage of traffic can be used to test circuit. Default: [1]
...
class CircuitBreaker extends EventEmitter {
  ...
  */
  ...
  call (context, ...rest) {
    ...
    if (this.halfOpen) {
      if (Math.random() <= this.halfOpenStage) {
        if (
          this[PERMITTED_NUMBER] >=
          this.options.permittedNumberOfCallsInHalfOpenState
        ) {
